...
const formulario2 = document.querySelector("#form_3");

 function login(){
    const datosFormulario = new FormData(formulario2);

    const datos = Object.fromEntries(datosFormulario.entries());

    let leer = new Usuario(datos.nombre, datos.apellido, datos.correo, datos.Contraseña);
    console.log(leer);
